...
<section id="page-<?php the_ID(); ?>" <?php body_class( array( 'page-content', 'connect' ) ); ?>>
    ...
    <div class="row">
        ...
        <div class="small-12 medium-4 columns sidebar-cta">
            ...
            <div class="cta-block">
                ...
                <?php foreach ( $social_accounts as $key => $social ) :
            ...
            <?php if ( have_rows( 'connect_sidebar_blocks' ) ) : 
            
                while ( have_rows( 'connect_sidebar_blocks' ) ) : the_row(); ?>
